...
public class ArticleDatafetcher {
  ...
  private Article buildArticleResult(ArticleData articleData) {
    return Article.newBuilder()
        ...
        .createdAt(articleData.getCreatedAt().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME) + "Z")
        ...
        .updatedAt(articleData.getUpdatedAt().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME) + "Z")
        .build();
  }
}
